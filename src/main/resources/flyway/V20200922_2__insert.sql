...
VALUES
(1,'dam','dam2','cam3','bim4','bim5',2,'bim6',3,'bim7',true,true,4,'bim8',5,6,7,8),
(1,'dam','dam2','cam3','bim4','bim5',2,'bim6',3,'bim7',true,true,4,'bim8',5,6,7,8),
(1,'dam','dam2','cam3','bim4','bim5',2,'bim6',3,'bim7',true,true,4,'bim8',5,6,7,8);

INSERT INTO authentication (id,username,email,password,rope,forgot_password_key,forgot_password_key_timestamp,company_unit_id)
VALUES
(1,'bim1','bim2','bim3','bim4','bim5',1,2),
(2,'bim1','bim2','bim3','bim4','bim5',1,2),
(3,'bim1','bim2','bim3','bim4','bim5',1,2);

INSERT INTO record (id,number,type,company_unit_id,created_timestamp,created_by,updated_timestamp,updated_by)
VALUES
(1,'bim1','bim2',1,2,3,4,5),
(2,'bim1','bim2',1,2,3,4,5),
(3,'bim1','bim2',1,2,3,4,5);
...
INSERT INTO history_request( request_id, status, created_timestamp, created_by, updated_timestamp, updated_by)
VALUES (1,'status1',1,1,1,1),
       (2,'status2',2,2,2,2),
       (3,'status3',3,3,3,3);
INSERT INTO act(act_number,base,structural_subdivision_id,created_timestamp,created_by,updated_timestamp,updated_by)
